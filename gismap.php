	...
	<div class="container">
		...
		<div class="row" -->
			<div class="col-md-11">
			 ...
			 <div id="docking" class="col-md-11">
				 <div>
				<div id="searchWindow">
				<div>Search</div>
				<div style="overflow: hidden;height:260px;">
					<div id="jqxTabs" >
						...
						<br/>
							<div style="float:left;margin: 0 10px 10px 5px;">
								<ul id='layerSpan' class='toolbarSR'>
									...
									<li class="toolbarButton layerButtonSR searchResultIcon active" title="Arkansas Better Chance" id="3">
										<span class="centerText"><img src="img/3.png" />
										</span>
									</li>
									<li class="toolbarButton layerButtonSR searchResultIcon active" title="Child Care Facilities" id="4">
										<span class="centerText"><img src="img/4.png" />
										</span>
									</li>
									<li class="toolbarButton layerButtonSR searchResultIcon active" title="Head Start Programs" id="5">
										<span class="centerText"><img src="img/5.png" />
										</span>
									</li>
								</ul>
							</div>
							<div id="searchResultText" style="padding-left:5px"></div>
							<div id="searchResults" class="dataTables" style="clear:both">
							</div>
						</div>
					</div>
				</div>
				   ...
				   <div id="aecamWindow" >
						<div>AECAM Layers</div>
							<div style="height:100%;">
								<div id="layerDiv" style="clear:both;">
...
<script>
	...
	$(document).ready(function () {
		$('#aecamWindow').jqxWindow({ height: 'auto', width: 350,  position: { x: 30, y: 50},autoOpen: false,showCollapseButton: true });
		$('#searchWindow').jqxWindow({ height: '330px', width: 350,  position: { x: 30, y: 80},autoOpen: false, showCollapseButton: true });
		$('#geographyWindow').jqxWindow({ height: 'auto', width: 350,  position: { x: 30, y: 110},autoOpen: false, showCollapseButton: true });
		$('#demographicWindow').jqxWindow({ height: 'auto', width: 350,  position: { x: 30, y: 140},autoOpen: false, showCollapseButton: true });
		...
		var dataFields = [
			...
			{id: '7', key: "OBJECTID", field: "CITY_NAME", qryField: "City", menuDivName: 'cities', searchLayerName: cities},
			{id: '8', key: "OBJECTID", field: "NAME10", qryField: "County", menuDivName: 'school', searchLayerName: counties}
			//{id: '9', key: "OBJECTID", field: "NAME10", qryField: "County", menuDivName: 'counties', searchLayerName: counties}
		];
		...
		*****************************************/
		...
		$("#searchButton").on('click', function(){
			...
			searchText =  $('#program').text() + " by " + $('#searchGeography').text() + " : " + searchTerm;
